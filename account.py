...
# 1. Add attributes deposits and withdrawals in the init method which are empty lists by default
# and another attribute loan_balance which is zero by default.
